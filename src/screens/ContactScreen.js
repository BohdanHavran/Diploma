    ...
    const handleConfirmOrder = async () => {
        try {
            ...
            if (response.ok) {
                ...
                swal("Успішно!", "Замовлення оформлено. Корзина очищена.", "success");
            } else {
            ...
            {isOrderConfirmed && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        <h2 className="text-2xl font-bold text-green-600">Успішно оформлене!</h2>
                        <p className="mt-4">Ваше замовлення було успішно оформлено і доступне для обробки в адмін панелі.</p>
                        <button
