...
import Product from '../components/products/ProductAdmin';
...
const ProductsScreen = () => {
    ...
    const sortedProducts = [...filteredProducts].sort((a, b) => {
        ...
        if (sortOption === 'count-asc') return a.count - b.count;
        if (sortOption === 'count-desc') return b.count - a.count;
        return 0;
    });
    ...
    return (
        <section className="max-w-screen-xl py-24 mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-6">
                ...
                {user.status > 0 && (
                    <button
                        className="w-36 h-16 btn-primary py-auto px-auto mx-auto my-auto poppins text-sm bg-green-500 text-white hover:bg-green-600"
