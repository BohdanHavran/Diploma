...
output "connection_pool_id" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.id
  }
...
output "connection_pool_host" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.host
  }
...
output "connection_pool_private_host" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.private_host
  }
...
output "connection_pool_port" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.port
  }
...
output "connection_pool_uri" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.uri
  }
  sensitive   = true
...
output "connection_pool_private_uri" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.private_uri
  }
  sensitive   = true
...
output "connection_pool_password" {
  value = {
    for k, pool in digitalocean_database_connection_pool.this : k => pool.password
  }
  sensitive   = true
...
output "db_name" {
  value = [
    for db in digitalocean_database_db.this : db.name
  ]
...
output "user_role" {
  value = {
    for k, user in digitalocean_database_user.this : k => user.role
  }
...
output "user_password" {
  value = {
    for k, user in digitalocean_database_user.this : k => user.password
  }
  sensitive   = true
...
output "database_firewall_rule" {
  value = [
    for r in digitalocean_database_firewall.this[*].rule : r
  ]
