...
output "thistenance_policy_day" {
  value       = digitalocean_kubernetes_cluster.this[*].thistenance_policy
  description = "A block representing the cluster's thistenance window. Updates will be applied within this window."
}
output "local_file" {
